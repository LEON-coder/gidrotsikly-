const cardAddArr = Array.from(document.querySelectorAll(".cart-link"));
const cartNum = document.querySelector(".header__count_number");
const cart = document.querySelector(".header__cart--block");
